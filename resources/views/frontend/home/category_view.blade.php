  ...
  <div class="full-width_border border-2" style="border-color: #f5e6e0;">
    <div class="shop-banner position-relative ">
      ...
      <div class="shop-banner__content container position-absolute start-50 top-50 translate-middle">
        <h2 class="h1 text-uppercase text-center fw-bold mb-3 mb-xl-4 mb-xl-5">Categorized Product</h2>
          ...
          <div class="accordion-body px-0 pb-0 pt-3">
            <ul class="list list-inline mb-0">
              @foreach($categories as $category)
                <li class="list-item">
                  <a href="{{ url('product/category/'.$category->id.'/'.$category->category_slug) }}" class="menu-link py-1">{{ $category->category_name }}</a>
                </li>
              @endforeach
            </ul>
          </div>
  ...
  <div class="shop-list flex-grow-1">
    <div class="d-flex justify-content-between mb-4 pb-md-2">
      <div class="breadcrumb mb-0 d-none d-md-block flex-grow-1">
        ...
        <a href="#" class="menu-link menu-link_us-s text-uppercase fw-medium">{{ $breadcat->category_name }}</a>
      </div><!-- /.breadcrumb -->
        ...
        <div class="product-card-wrapper">
          <div class="product-card mb-3 mb-md-4 mb-xxl-5">
            ...
            <div class="pc__info position-relative">
              ...
              <button class="pc__btn-wl position-absolute top-0 end-0 bg-transparent border-0 js-add-wishlist" title="Add To Wishlist" id="{{ $product->id }}" onclick="addToWishList(this.id)" >
