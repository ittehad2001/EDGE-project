                    ...
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          ...
                          <h2 class="mb-3 font-18">TK. ${{ $today }} BD</h2>
                        </div>
                      </div>
                ...
                <div class="card-statistic-4">
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <h5 class="font-15">Monthly Sale</h5>
                          <h2 class="mb-3 font-18">Tk. ${{ $month }}BD</h2>
                        </div>
                      </div>
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                ...
                <div class="card-statistic-4">
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <h5 class="font-15">Yearly Sale</h5>
                          <h2 class="mb-3 font-18">Tk. ${{ $year }}BD</h2>
                    ...
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          ...
                          <h2 class="mb-3 font-18">{{ count($pending) }}</h2>
            ...
            <div class="card-body">
                <div class="card radius-10">
                    <div class="card-body">
                        ...
                        </div> <!-- Closing for table-responsive -->
                    </div> <!-- Closing for inner card-body -->
                </div> <!-- Closing for inner card -->
            </div> <!-- Closing for outer card-body -->
        </div> <!-- Closing for outer card -->
    </div> <!-- Closing for col-12 -->
</div> <!-- Closing for row -->
